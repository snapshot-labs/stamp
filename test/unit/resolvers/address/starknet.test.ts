...
import { lookupAddresses, resolveNames } from '../../../../src/resolvers/address/starknet';
...
describe('Starknet address resolver', () => {
  describe('resolveNames()', () => {
    ...
    describe('when the contract returns a value that is not an address', () => {
      ...
      ])('rejects on %s, leaving the report to resolvers/address/index', async (_, value) => {
        mockAddresses(value);
    ...
    it('rejects when the call fails, leaving the report to resolvers/address/index', async () => {
  ...
  describe('lookupAddresses()', () => {
    ...
    it('rejects with any other error, leaving the report to resolvers/address/index', async () => {
