...
testResolverImageSnapshots({
  ...
  falseCases: [
    { description: 'should return false if missing', args: [noAvatarInputs.snapshotUserMissing] },
    {
...
testResolverImageSnapshots({
  ...
  falseCases: [
    { description: 'should return false if missing', args: [noAvatarInputs.snapshotSpaceMissing] },
    {
      description: 'returns false for a normal address with no avatar',
      args: [NO_AVATAR_ADDRESS]
    },
