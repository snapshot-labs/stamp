...
import resolve from '../../../src/resolvers/zapper';
...
const fixture = remoteResolverFixtures.zapper;

describe('resolvers', () => {
  describe('zapper pixel snapshot', () => {
    beforeEach(() => {
    ...
    it('resizes the fetched image deterministically', async () => {
      ...
      expect(png).toMatchImageSnapshot({
        customSnapshotIdentifier: 'zapper-resize'
      });
    });
  });
});
